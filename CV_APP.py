...
with st.container():
    ...
    st.subheader("This section was implemented using stpvista and pyvista and worked when deployed locally but I had to revert to images as streamlit cloud didn't support the implementation. This is in theory possible on AWS or other deployment platforms")
