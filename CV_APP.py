...
with st.container():
    ...
    st.subheader("This section was implemented using stpvista and pyvista and worked when deployed locally but I had to revert to images as streamlit cloud didnt support the implementation. This is in theory possible on AWS or other sources")
